...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2022 pada 20.42
...
--
-- Struktur dari tabel `tbl_students_0562`
--

CREATE TABLE `tbl_students_0562` (
  `id` int(4) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0562`
--

INSERT INTO `tbl_students_0562` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indeks untuk tabel `tbl_students_0562`
--
ALTER TABLE `tbl_students_0562`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_students_0562`
--
ALTER TABLE `tbl_students_0562`
